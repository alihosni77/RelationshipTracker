...
export default function FeatureScreen() {
  ...
  return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content}>
    ...
    {feature === 'location' && <Consent title="Share my live location" body="Your partner can only see this while you choose to share. Set an expiry before enabling it." enabled={enabled} setEnabled={setEnabled}/>}</n+    {feature === 'wellbeing' && <Consent title="Share supportive reminders" body="Cycle information is private by default. This never affects relationship scores and can be withdrawn immediately." enabled={enabled} setEnabled={setEnabled}/>} 
